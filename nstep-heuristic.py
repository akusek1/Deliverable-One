...
# Description: Implement a bot that uses n-step look ahead and your own board evaluation heuristic
#              Code from Alexis Cook's One-Step Lookahead and N-Step Lookahead tutorials
...
def score_move(grid, col, mark, config, nsteps):
    ...
    score = minimax_alpha_beta(next_grid, nsteps-1, False, mark, config)
    return score
